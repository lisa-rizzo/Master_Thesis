...
spec = {
    ...
    "lr_scheduler": True,
    "lr_end_factor": 0.01,
    "batch_size": 4,  # Sehr klein wegen Speicherproblem
...
trainer = Trainer(
    ...
    callbacks=[loss_logger],  # Only callbacks here
    logger=tb_logger,         
    check_val_every_n_epoch=1  #validate at the end of every epoch (default)
)
